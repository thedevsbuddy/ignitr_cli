...
const List<Map<String, String>> _allowedCommands = [
  ...
  {"name": "design:generate", "description": "Generates core design system using config files defined in `configs` directory.", "usage": "design:generate"},
];
  ...
  Future<void> run() async {
    ...
    switch (command) {
      ...
      case "design:generate":
        ...
        await designSystemService.init(args, argResults);
        await designSystemService.handle();
        await Utils.formatGeneratedCode();
        break;
